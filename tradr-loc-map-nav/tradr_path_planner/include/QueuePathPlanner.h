...
#include <tradr_trajectory_control_msgs/message_enums.h>
...
struct TaskSegment
{
    ...
    tradr_trajectory_control_msgs::PlanningTask segment_task;
    ...
    boost::shared_ptr<PathPlanner> p_tradr_path_planner; // the used path planner instance
...
protected:
    ...
    void appendCallback(const tradr_trajectory_control_msgs::PlanningTask& task_msg);
    void removeCallback(const tradr_trajectory_control_msgs::PlanningTask& task_msg);
