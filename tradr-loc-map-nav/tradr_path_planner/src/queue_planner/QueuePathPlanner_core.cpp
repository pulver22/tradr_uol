...
QueuePathPlanner::QueuePathPlanner(void)
{
    ...
    task_global_path_pub_ = node_.advertise<tradr_trajectory_control_msgs::PlanningGlobalPath>("/planner/tasks/global_path", 1); 
    ...
    task_feedback_pub_ = node_.advertise<tradr_trajectory_control_msgs::PlanningFeedback>("/planner/tasks/feedback", 20);
    ...
    task_remove_pub_ = node_.advertise<tradr_trajectory_control_msgs::PlanningTask>("/planner/tasks/remove",1);
