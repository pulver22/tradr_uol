...
QueueTrajectoryController::QueueTrajectoryController(void)
{
    ...
    task_feedback_pub_ = node_.advertise<tradr_trajectory_control_msgs::PlanningFeedback>("/planner/tasks/feedback", 1);
...
void QueueTrajectoryController::feedbackCallback(const tradr_trajectory_control_msgs::PlanningFeedback& feedback_msg)
{
...
{
    // ros initialization
    ros::init(argc, argv, "queue_tradr_trajectory_controller");
