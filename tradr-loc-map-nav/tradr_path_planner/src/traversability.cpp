...
void multiRobotPoseCallback(const tradr_trajectory_control_msgs::MultiRobotPose& msg)
{
    trav_analyzer.setMultiRobotPose(msg);
}

void multiRobotPathsCallback(const tradr_trajectory_control_msgs::MultiRobotPath& msg)
{
    boost::recursive_mutex::scoped_lock locker(trav_analyzer_mutex);
