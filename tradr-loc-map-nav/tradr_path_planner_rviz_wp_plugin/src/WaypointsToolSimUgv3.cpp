...
PLUGINLIB_EXPORT_CLASS(tradr_path_planner_rviz_wp_plugin::WaypointsToolSimUgv3, rviz::Tool)
...
//    }
    ...
    resource_success_ = "package://tradr_path_planner_rviz_wp_plugin/mesh/barrier_success3.dae";
