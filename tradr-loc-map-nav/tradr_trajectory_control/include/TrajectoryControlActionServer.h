...
#ifndef tradr_trajectory_control_ACTIONSERVER_H_
#define tradr_trajectory_control_ACTIONSERVER_H_

#include <ros/ros.h>
#include <actionlib/server/simple_action_server.h>
#include <actionlib/client/simple_action_client.h>

#include <tradr_trajectory_control_msgs/TrajectoryControlAction.h>
...
#include <tradr_trajectory_control_msgs/MultiRobotPath.h> 
#include <tradr_trajectory_control_msgs/message_enums.h> // for SegmentStatus and TaskType
...
protected:
    ...
    actionlib::SimpleActionServer<tradr_trajectory_control_msgs::TrajectoryControlAction> act_server_;
    actionlib::SimpleActionClient<tradr_trajectory_control_msgs::TrajectoryControlAction> act_client_;

    tradr_trajectory_control_msgs::TrajectoryControlFeedback feedback_msg_;
    tradr_trajectory_control_msgs::TrajectoryControlResult result_msg_;
    ...
    std::string tradr_trajectory_control_abort_topic_;
    ros::Subscriber tradr_trajectory_control_abort_sub_;
...
public: /// < callbacks     
    ...
    void executeCallback(const tradr_trajectory_control_msgs::TrajectoryControlGoalConstPtr&);
    ...
    void queueFeedbackCallback(const tradr_trajectory_control_msgs::PlanningFeedback& feedback_msg);
...
protected: /// < other functions          
    ...
    void executeRotation(const tradr_trajectory_control_msgs::TrajectoryControlGoalConstPtr&);
