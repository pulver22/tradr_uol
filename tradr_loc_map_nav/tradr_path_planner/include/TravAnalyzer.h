...
#include <tradr_trajectory_control_msgs/MultiRobotPose.h>
...
public: /// < setters     
    ...
    void setMultiRobotPose(const tradr_trajectory_control_msgs::MultiRobotPose& msg);
    void setMultiRobotPath(const tradr_trajectory_control_msgs::MultiRobotPath& msg);
