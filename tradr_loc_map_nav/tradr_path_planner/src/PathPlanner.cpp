...
{
    markerArrPub_ = n_.advertise<visualization_msgs::MarkerArray>("/tradr_path_planner/visited_nodes", 1);
    localPathPub_ = n_.advertise<nav_msgs::Path>("/tradr_path_planner/localPath", 1);
}
