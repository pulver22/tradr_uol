...
void TravAnalyzer::setMultiRobotPose(const tradr_trajectory_control_msgs::MultiRobotPose& msg)
{
    if (!b_enable_team_avoidance_) return;
...
void TravAnalyzer::setMultiRobotPath(const tradr_trajectory_control_msgs::MultiRobotPath& msg)
{
    if (!b_enable_team_avoidance_) return;
