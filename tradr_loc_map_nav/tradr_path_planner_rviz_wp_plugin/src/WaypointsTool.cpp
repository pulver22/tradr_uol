...
namespace tradr_path_planner_rviz_wp_plugin   
{
...
)
{
    ...
    task_feedback_pub_ = node_.advertise<tradr_trajectory_control_msgs::PlanningFeedback>(planner_task_feedback_topic_name, 10);
    ...
    // publisher
    task_append_pub_ = node_.advertise<tradr_trajectory_control_msgs::PlanningTask>(planner_task_append_topic_name, 1);
    task_remove_pub_ = node_.advertise<tradr_trajectory_control_msgs::PlanningTask>(planner_task_remove_topic_name, 1);
...
//    markers_interactive_menu_.insert("Patrolling - Restart", boost::bind(&WaypointsTool::markerInteractiveCallback, this, _1));
    ...
    resource_interactive_ = "package://tradr_path_planner_rviz_wp_plugin/mesh/barrier_interactive.dae";
    ...
    resource_failure_ = "package://tradr_path_planner_rviz_wp_plugin/mesh/barrier_failure.dae";
    ...
    resource_success_ = "package://tradr_path_planner_rviz_wp_plugin/mesh/barrier_success.dae";
    ...
    resource_static_ = "package://tradr_path_planner_rviz_wp_plugin/mesh/barrier_static.dae";
...
void WaypointsTool::taskAppend(const ros::Time& stamp, uint8_t task_type)
{
    ...
    tradr_trajectory_control_msgs::PlanningTask task_msg;
    visualization_msgs::InteractiveMarker marker;
...
void WaypointsTool::feedbackCallback(const tradr_trajectory_control_msgs::PlanningFeedback& feedback_msg)
{
...
} // end namespace tradr_path_planner_rviz_wp_plugin
