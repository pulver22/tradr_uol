...
PLUGINLIB_EXPORT_CLASS(tradr_path_planner_rviz_wp_plugin::WaypointsToolSimUgv2, rviz::Tool)
...
//    }
    ...
    resource_success_ = "package://tradr_path_planner_rviz_wp_plugin/mesh/barrier_success2.dae";
