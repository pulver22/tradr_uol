...
b_use_teleop_mux_service_(false)
{
    ...
    tradr_trajectory_control_abort_topic_ = getParam<std::string>(param_node_, "tradr_trajectory_control_abort_topic", "/tradr_trajectory_control_abort_topic");
    ...
    tradr_trajectory_control_abort_sub_ = node_.subscribe(tradr_trajectory_control_abort_topic_, 1, &TrajectoryControlActionServer::goalAbortCallback, this); /// < use the same callback of goal abort!
    ...
    // feedback between nodes: "tool", "planner" and "control"
    queue_task_feedback_pub_ = node_.advertise<tradr_trajectory_control_msgs::PlanningFeedback>(queue_task_feedback_topic_, 1);

    multi_robot_paths_pub_ = node_.advertise<tradr_trajectory_control_msgs::MultiRobotPath>(multi_robot_paths_topic_, 1);
...
void TrajectoryControlActionServer::executeCallback(const tradr_trajectory_control_msgs::TrajectoryControlGoalConstPtr &goal_msg)
{
    ...
    tradr_trajectory_control_msgs::PlanningFeedback planning_feedback_msg;
...
void TrajectoryControlActionServer::executeRotation(const tradr_trajectory_control_msgs::TrajectoryControlGoalConstPtr &goal_msg)
{
...
void TrajectoryControlActionServer::robotPathCallBack(const nav_msgs::PathConstPtr &msg)
{
    ...
    tradr_trajectory_control_msgs::TrajectoryControlGoal track_goal;
    track_goal.path = *msg;
...
void TrajectoryControlActionServer::queueFeedbackCallback(const tradr_trajectory_control_msgs::PlanningFeedback& feedback_msg)
{
...
{
    tradr_trajectory_control_msgs::MultiRobotPath multi_robot_path_msg;
